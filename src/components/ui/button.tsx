  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-all duration-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-primary text-primary-foreground uppercase tracking-[0.2em] text-xs font-medium hover:scale-105 active:scale-100",
        heroOutline: "border border-foreground bg-transparent text-foreground uppercase tracking-[0.2em] text-xs font-medium hover:bg-foreground hover:text-background",
        minimal: "bg-transparent text-foreground uppercase tracking-[0.15em] text-xs font-medium hover:opacity-70 underline underline-offset-8",
      },
      size: {
